...
function WalletPage({ changePage, address }: WalletPageProps) {
  ...
  useEffect(() => {
    ...
    url.search = new URLSearchParams({ address: address }).toString();
  ...
  return (
    <SwitchTransition>
      <CSSTransition key={"" + importing} classNames="page-d1" timeout={300}>
        {importing ? (
          <AwaitImportPage />
        ) : (
          <div className={`page page-d1`}>
            <div className="header">
              ...
              <h1 className="text-2xl leading-loose">
                Select any number of Asunas to import
              </h1>
              <p>
                Imported Asunas will be unable to be withdrawn for a period of 3
                days.
              </p>
            </div>
